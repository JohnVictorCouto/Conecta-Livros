...
public class ListaEscolarDAO {
    ...
    // Insere uma nova lista escolar no banco de dados
    ...
    // Atualiza os dados de uma lista escolar existente
    ...
    // Exclui uma lista escolar pelo ID
    ...
    // Lista todas as listas escolares em ordem alfabetica
    ...
    // Busca uma lista escolar pelo ID
    ...
    // Obtem todos os livros de uma lista escolar.
    ...
    public static boolean adicionarLivro(int listaId, int livroId) {
        ...
        try {
            ...
            System.err.println("Erro ao adicionar livro Ã  lista: " + e.getMessage());
            if (conn != null) {
                try {
                    conn.rollback();
                } catch (SQLException ex) {
    ...
    // Converte uma linha do banco em objeto Livro

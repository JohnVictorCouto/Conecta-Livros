...
public class LivroDAO {
    ...
    public static boolean inserir(Livro livro) {
        ...
        try {
            ...
            String sql = "INSERT INTO livro (title, authors, description, cover, " +
                        "publish_month, publish_year, disponibilidade, genre_id, " +
                        "publisher_id, estante_id) " +
                        "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            
            stmt = conn.prepareStatement(sql);
            stmt.setString(1, livro.getTitle());
            stmt.setString(2, livro.getAuthors());
            stmt.setString(3, livro.getDescription());
            stmt.setString(4, livro.getCover());
            stmt.setInt(5, livro.getPublishMonth());
            stmt.setInt(6, livro.getPublishYear());
            stmt.setBoolean(7, livro.isDisponibilidade());
            stmt.setInt(8, livro.getGenreId());
            stmt.setInt(9, livro.getPublisherId());
            if (livro.getEstanteId() > 0) {
                stmt.setInt(10, livro.getEstanteId());
            } else {
    ...
    public static boolean atualizar(Livro livro) {
        ...
        try {
            ...
            String sql = "UPDATE livro SET title = ?, authors = ?, description = ?, " +
    ...
    public static List<Livro> buscar(String termo) {
        ...
        try {
            ...
            String sql = "SELECT * FROM livro WHERE title LIKE ? OR authors LIKE ? " +
                        "ORDER BY title ASC";

...
public class LivroDAO {
    ...
    // Busca livros por titulo, autor, ISBN ou idioma.
    ...
    public static List<Livro> obterPorGenero(int genreId) {
        ...
        try {
            ...
            System.err.println("Erro ao obter livros por gÃªnero: " + e.getMessage());
            return new ArrayList<>();
    ...
    // Obtem apenas livros disponiveis.
    public static List<Livro> obterDisponiveis() {
        ...
        try {
            ...
            System.err.println("Erro ao obter livros disponÃ­veis: " + e.getMessage());
            return new ArrayList<>();
    ...
    // Mapeia uma linha do banco para um objeto Livro.

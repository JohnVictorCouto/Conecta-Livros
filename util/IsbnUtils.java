...
// Classe utilitaria para limpar, validar e converter ISBNs
public class IsbnUtils {

    // Remove caracteres que nao fazem parte do ISBN
    public static String clean(String s) {
        if (s == null) return "";
        return s.replaceAll("[^0-9Xx]", "");
    }

    // Identifica o tamanho do ISBN e chama a validacao correta
    ...
    // Valida ISBN-10 pelo calculo do digito verificador
    ...
    // Valida ISBN-13 pelo calculo do digito verificador
    ...
    // Converte ISBN-10 para ISBN-13 quando possivel
    ...
    // Converte ISBN-13 com prefixo 978 para ISBN-10
    public static String toIsbn10(String isbn13) {
        ...
        String core = c.substring(3, 12); // Nove digitos principais do ISBN-10
        int sum = 0;
        for (int i = 0; i < 9; i++) {

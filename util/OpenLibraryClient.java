...
// Classe responsavel por buscar dados de livros na API Open Library
public class OpenLibraryClient {
    ...
    // Busca dados do livro pelo ISBN informado
    public static Livro buscarPorISBN(String isbn) throws Exception {
        ...
        // Extrai o objeto retornado para a chave ISBN informada
        String key = "\"ISBN:" + clean + "\"";
        int idx = body.indexOf(key);
        if (idx < 0) {
            // Tenta novamente usando X maiusculo no ISBN
        ...
        // Localiza o fechamento do objeto JSON retornado pela API
        int end = body.indexOf("}\n}", start); // Tenta o padrao comum de fechamento do JSON
        ...
        // Extrai a melhor URL de capa disponivel
    ...
    // Remove escapes simples retornados no JSON
    private static String unescape(String s) {
        return s.replaceAll("\\\\/", "/").replaceAll("\\\\\"", "\"");
    }

    // Converte codigos de idioma para nomes em portugues

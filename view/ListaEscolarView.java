...
// Tela de gerenciamento de listas escolares
public class ListaEscolarView extends JPanel {
    ...
    private static final String[] COLUNAS = {"ID", "Nome da Lista", "DescriÃ§Ã£o"};
    ...
    private void abrirFormulario(ListaEscolar lista) {
        ...
        ComponenteUI.CampoTexto campoNome = new ComponenteUI.CampoTexto("Ex: Lista do 9Âº Ano A");
        ...
        form.add(ComponenteUI.labelForm("DescriÃ§Ã£o"), gbc);
    ...
    private void abrirGerenciadorLivros(ListaEscolar lista) {
        ...
        dlg.add(headerDlg("Gerenciar Livros â€” " + lista.getName()), BorderLayout.NORTH);
        ...
        ComponenteUI.BotaoPrimario btnAdd = new ComponenteUI.BotaoPrimario("â† Adicionar Ã  Lista");
        ComponenteUI.BotaoPerigo btnRem   = new ComponenteUI.BotaoPerigo("Remover â†’");
        ...
        btnAdd.addActionListener(e -> {
            ...
            else aviso("Livro jÃ¡ estÃ¡ na lista ou ocorreu um erro.");
        });
    ...
    private void confirmarDelecao(ListaEscolar l) {
        int r = JOptionPane.showConfirmDialog(this,
            "Excluir a lista \"" + l.getName() + "\"?\nTodos os vÃ­nculos com livros serÃ£o removidos.",
            "Confirmar exclusÃ£o", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        if (r == JOptionPane.YES_OPTION && ListaEscolarDAO.deletar(l.getId())) { carregarDados(); sucesso("Lista excluÃ­da."); }
    }

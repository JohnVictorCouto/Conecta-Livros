...
public class LivroFormDialog extends JDialog {
        ...
        JButton btn = new JButton("+") {
            @Override protected void paintComponent(Graphics g) {
                ...
                g2.setColor(getModel().isPressed() || getModel().isRollover()
                    ? UITheme.ACCENT_HOVER : UITheme.ACCENT);
    ...
    private void preencherCombos() {
        for (int i = 0; i < comboGenero.getItemCount(); i++) {
            Genero g = comboGenero.getItemAt(i);
            if (g != null && g.getId() == livro.getGenreId()) {
        ...
        for (int i = 0; i < comboEditora.getItemCount(); i++) {
            ...
            if (e != null && e.getId() == livro.getPublisherId()) {
    ...
    private void abrirNovoGenero() {
        String nome = JOptionPane.showInputDialog(this,
            "Nome do novo Gênero:", "Cadastrar Gênero", JOptionPane.PLAIN_MESSAGE);
        if (nome != null && !nome.trim().isEmpty()) {
            ...
            if (GeneroDAO.inserir(g)) {
                ...
                JOptionPane.showMessageDialog(this,
                    "Erro ao cadastrar gênero.", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private void abrirNovaEditora() {
        String nome = JOptionPane.showInputDialog(this,
            "Nome da nova Editora:", "Cadastrar Editora", JOptionPane.PLAIN_MESSAGE);
        if (nome != null && !nome.trim().isEmpty()) {
            ...
            if (EditoraDAO.inserir(ed)) {
                ...
                JOptionPane.showMessageDialog(this,
                    "Erro ao cadastrar editora.", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private void salvar() {
        ...
        if (comboGenero.getSelectedItem() == null || comboEditora.getSelectedItem() == null) {
            JOptionPane.showMessageDialog(this,
                "Selecione gênero e editora.", "Atenção", JOptionPane.WARNING_MESSAGE);
            return;
        }

...
// Janela de cadastro e edicao de livros
public class LivroFormDialog extends JDialog {
    ...
    private JPanel criarHeader() {
        ...
        JLabel sub = new JLabel(livro != null
            ? "Atualize as informaÃ§Ãµes do livro"
    ...
    private JScrollPane criarForm() {
        ...
        campoTitulo  = new ComponenteUI.CampoTexto("TÃ­tulo do livro");
        ...
        campoMes     = new ComponenteUI.CampoTexto("MÃªs (1-12)");
        campoAno     = new ComponenteUI.CampoTexto("Ano ex: 2001");
        campoGenero  = new ComponenteUI.CampoTexto("Nome do gÃªnero");
        campoEditora = new ComponenteUI.CampoTexto("Nome da editora");

        comboEstante = estilizarCombo(new JComboBox<>());

        checkDisp = new JCheckBox("DisponÃ­vel para emprÃ©stimo");
        ...
        addField(form, gbc, "TÃ­tulo *",    campoTitulo, row++);
        ...
        // Mes e ano lado a lado
        JPanel pubPanel = new JPanel(new GridLayout(1, 2, 10, 0));
        pubPanel.setOpaque(false);
        pubPanel.add(campoMes);
        pubPanel.add(campoAno);
        addField(form, gbc, "MÃªs / Ano de PublicaÃ§Ã£o", pubPanel, row++);

        addField(form, gbc, "GÃªnero *",  campoGenero,  row++);
        ...
        // Mantem os campos alinhados no topo
        gbc.gridy   = row * 2 + 1;
        gbc.weighty = 1.0;
    ...
    private JPanel criarRodape() {
        ...
        ComponenteUI.BotaoPrimario btnSalvar   = new ComponenteUI.BotaoPrimario(
            livro != null ? "Salvar AlteraÃ§Ãµes" : "Cadastrar Livro");
        ...
        new SwingWorker<Void, Void>() {
            protected Void doInBackground() {
                ...
                SwingUtilities.invokeLater(() -> {
                    ...
                    comboEstante.addItem(null); // Opcao para livro sem estante
    ...
    private void preencherCombos() {
        if (livro.getEstanteId() > 0) {
            ...
            comboEstante.setSelectedIndex(0); // Item nulo representa livro sem estante
        }
    }
                ...
                try {
                    ...
                    if (dados != null) {
                        ...
                        JOptionPane.showMessageDialog(LivroFormDialog.this,
                            "Livro nÃ£o encontrado pelo ISBN informado.", "Aviso", JOptionPane.INFORMATION_MESSAGE);
                    }
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(LivroFormDialog.this,
    ...
    private void salvar() {
        ...
        if (titulo.isEmpty()) {
            JOptionPane.showMessageDialog(this,
                "O tÃ­tulo Ã© obrigatÃ³rio.", "AtenÃ§Ã£o", JOptionPane.WARNING_MESSAGE);
            return;
        }
        if (nomeGenero.isEmpty() || nomeEditora.isEmpty()) {
            JOptionPane.showMessageDialog(this,
                "Informe gÃªnero e editora.", "AtenÃ§Ã£o", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            ...
            if (genero == null || editora == null) {
                JOptionPane.showMessageDialog(this,
                    "NÃ£o foi possÃ­vel localizar ou cadastrar gÃªnero/editora.", "Erro", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (ok) {
                ...
                JOptionPane.showMessageDialog(this,
                    "NÃ£o foi possÃ­vel salvar. Verifique os dados.", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(this,
                "MÃªs e ano devem ser nÃºmeros vÃ¡lidos.", "AtenÃ§Ã£o", JOptionPane.WARNING_MESSAGE);
        }
    }

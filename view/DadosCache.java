...
// Cache em memoria para nomes de generos, editoras e estantes
// Evita varias consultas repetidas ao banco de dados
public class DadosCache {
    ...
    public static String getNomeGenero(int id) {
        ...
        return GENEROS_CACHE.getOrDefault(id, "G̻nero " + id);
    }

...
// Tela de busca, filtros e resultados de livros
public class BuscaView extends JPanel {
    ...
    private JPanel criarConteudo() {
        ...
        JLabel sub = new JLabel("Pesquise por tÃ­tulo, autor, ISBN, idioma, editora ou gÃªnero");
        ...
        campoBusca = new ComponenteUI.CampoBusca("Buscar por tÃ­tulo, autor, ISBN, idioma ou editora...", 400);
        ...
        checkDisp = new JCheckBox("Apenas disponÃ­veis");
        ...
        new SwingWorker<DadosFiltros, Void>() {
            ...
            protected void done() {
                try {
                    ...
                    comboGenero.addItem(new Genero(0, "GÃªneros"));
    ...
    private JPanel criarLinhaLivro(Livro livro) {
        ...
        JLabel lblTitulo = new JLabel(livro.getTitle() != null ? livro.getTitle() : "Sem tÃ­tulo");
        ...
        JLabel lblEstante = new JLabel("ðŸ“ " + nomeEstante);
        ...
        if (livro.getIdioma() != null && !livro.getIdioma().isBlank()) {
            JLabel lblIdioma = new JLabel("ðŸŒ " + livro.getIdioma());
        ...
        if (livro.getIsbn() != null && !livro.getIsbn().isBlank()) {
            JLabel lblIsbn = new JLabel("ðŸ“š ISBN: " + livro.getIsbn());
        ...
        // Lado direito com status e botoes
        ...
        JButton btnEdit = new JButton("âœï¸");
